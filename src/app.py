...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique work, lap swimming, and swim meets",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and seasonal theatrical productions",
    ...
    "Debate Team": {
        "description": "Public speaking, argumentation skills, and interschool debates",
